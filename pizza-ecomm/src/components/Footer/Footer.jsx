  ...
  return (
    <div>
      <span className='disclaimer'>
        * weight of just cooked product. The weight in delivery 
        orders may differ due to dehydration of the product.
      </span>
        ...
        <div className='footer-second'>
          ...
          <div className="section-grid">
            ...
            <div className='section-app'>
              ...
              <div className='application'>
                <img src="https://www.svgrepo.com/show/475863/play-store.svg" alt="" className="icon" />
                <div>
                  <span className='application-place' style={{textTransform: 'uppercase'}}>Get it on</span>
          ...
          <div className="section-grid">
            ...
            <div className='section-payment'>
                <img src="https://www.svgrepo.com/show/473823/visa.svg" style={{filter: 'invert(1)'}} alt="" className="icon" />
                <img src="https://www.svgrepo.com/show/362011/mastercard.svg"  alt="" className="icon" /> 
            </div>
          </div>
          <div className="section-grid">
            <span>
